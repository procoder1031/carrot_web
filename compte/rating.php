...
<html>
	...
	<body>
		...
		<div class="topnav">
			...
			<a class="active" href="rating.php"><?php echo TXT_RATING ?></a>
			<a href="conges.php"><?php echo TXT_CONGES ?></a>
		</div>
		<div id="content">
			<h2><?php echo TXT_PAGE_RATING; ?></h2>
			<p><?php echo TXT_MSG_RATING ?></p>
			<table class="files" summary="Fichiers à télécharger">
				...
				<tbody>
					<?php
					foreach (new DirectoryIterator("../repertoires_fournisseurs/" . $_SESSION['user'] . "/RATING") as $fileInfo) {
