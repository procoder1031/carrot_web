...
<html>
	...
	<body>
		...
		<div class="topnav">
			 ...
			 <a class="active" href="livraisons.php"><?php echo TXT_LIVRAISON; ?></a>
		...
		<div id="content">
			<h2><?php echo TXT_PAGE_LIVRAISON; ?></h2>
			<p><?php echo TXT_MSG_LIVRAISON; ?></p>
			<table class="files" summary="Fichiers à télécharger">
				...
				<tbody>
					<?php
					foreach (new DirectoryIterator("../repertoires_fournisseurs/" . $_SESSION['user'] . "/CALL_OF") as $fileInfo) {
