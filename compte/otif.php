	...
	<body>
		...
		<div id="content">
			...
			<table class="files" summary="Fichiers à télécharger">
				...
				<tbody>
					<?php
					foreach (new DirectoryIterator("../repertoires_fournisseurs/" . $_SESSION['user'] . "/OTIF") as $fileInfo) {
